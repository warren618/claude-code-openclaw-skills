...
DEFAULT_CLAUDE = os.environ.get("CLAUDE_CODE_BIN", "claude")  # Use 'claude' from PATH, or set CLAUDE_CODE_BIN
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help=(
            ...
            "Default: bypassPermissions (auto-approve all operations for seamless automation)."
        ),
    )
